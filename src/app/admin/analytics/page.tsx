      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-200">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Detailed reports and business insights</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Advanced Analytics Coming Soon</h2>
